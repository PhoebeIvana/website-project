...
import hero_image from "../Assets/hero_image.jpg"; // This should be a high-quality, subtle image
  ...
  return (
    <div className="relative h-screen bg-gray-50">
      ...
      <div className="relative z-10 flex flex-col items-start justify-center h-full px-10 text-left">
        <h2 className="text-5xl font-bold text-gray-800">New Arrivals Only!</h2>
        ...
        <div className="mt-8">
          ...
          <img src={arrow_icon} alt="Arrow Icon" className="mt-2" />
        </div>
      </div>
    </div>
  );
